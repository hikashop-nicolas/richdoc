...
const dict: Dict = {
  ...
  assist: "Assist",
  assistTranslate: "Translate selection",
  assistElaborate: "Elaborate selection",
  assistShorten: "Shorten selection",
  assistWrite: "Write…",
  assistFrom: "From",
  assistTo: "To",
  assistWritePlaceholder: "Describe what to write…",
  assistGenerate: "Generate",
  assistAccept: "Accept",
  assistCancel: "Cancel",
  assistLoading: "Preparing…",
  assistDownloading: "Downloading model {pct}%",
  assistGenerating: "Generating…",
  assistDone: "Done. Runs entirely on your device.",
  assistError: "Error: {msg}",
  assistUnavailable: "The on-device model could not be loaded.",
  assistNeedInput: "Enter an instruction first.",
};
