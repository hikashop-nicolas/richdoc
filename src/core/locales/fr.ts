...
const dict: Dict = {
  ...
  vaBottom: "Bas",
  vaJustify: "Justifié",
  readFailed: "Ce document n'a pas pu être ouvert. Il est affiché en lecture seule et l'enregistrement renvoie le fichier inchangé.",
  assist: "Assistant",
  assistTranslate: "Traduire la sélection",
  assistElaborate: "Développer la sélection",
  assistShorten: "Raccourcir la sélection",
  assistWrite: "Rédiger…",
  assistFrom: "De",
  assistTo: "Vers",
  assistWritePlaceholder: "Décrivez ce qu'il faut rédiger…",
  assistGenerate: "Générer",
  assistAccept: "Accepter",
  assistCancel: "Annuler",
  assistLoading: "Préparation…",
  assistDownloading: "Téléchargement du modèle {pct} %",
  assistGenerating: "Génération…",
  assistDone: "Terminé. Tout se passe sur votre appareil.",
  assistError: "Erreur : {msg}",
  assistUnavailable: "Le modèle local n'a pas pu être chargé.",
  assistNeedInput: "Saisissez d'abord une instruction.",
};
