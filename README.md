...
- **Page layout:** page size, margins, orientation and a page border (style, width,
  colour) in a paginated page view, with horizontal + vertical margin rulers that follow
  the caret's page, zoom, and a page setup dialog.
